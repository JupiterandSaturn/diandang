<template>
  ...
  <el-form-item label="验证码"  >
    <el-input  placeholder="请输入验证码"  v-model="ruleForm.pictest"></el-input>
    <el-input   v-text="ruleForm.testNum" :style="{width:wid-100+'px'}"></el-input>
    <span >换一个</span>
  </el-form-item>
  ...
  <el-form-item label="密码" prop="pass" >
    <el-input type="password" v-model="ruleForm.pass" autocomplete="off" placeholder="至少6个字符含数字大小写字母" ></el-input>
  </el-form-item>
  ...
  <el-form-item>
    <el-button type="primary" @click="submitForm('ruleForm')" :style="{background:back,margin:'0px 50px 0 0 '}">创建账户</el-button>
